...
import { rewriteWithSvgOptimizations } from './optimize.js'
import { config, logger, ensureDirectories } from './utils.js'
...
async function runCommonOptimizations() {
  ...
  for (let filename of filenames) {
    ...
    promises.push(rewriteWithSvgOptimizations(filePath))
  }
